...
############## Adding Role info into database ################

# Add Tank info to database
db.addRole("Tank", "Tanks protect their allies by drawing enemies' attacks toward themselves and absorbing damage.")

# Add Healer info to database
db.addRole("Healer", "Healers keep their allies alive by healing their wounds and protecting them from harm.")
